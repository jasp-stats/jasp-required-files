...
#define R_OS "darwin15.6.0"

/* Define this to be the canonical name (cpu-vendor-os) of your system. */
#define R_PLATFORM "x86_64-apple-darwin15.6.0"
...
#define PLATFORM_PKGTYPE "mac.binary.el-capitan"
